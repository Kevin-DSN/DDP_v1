...
public class ArchivoProveedoresMostrar extends javax.swing.JFrame {

    String url = "jdbc:mysql://localhost:3306/base_periodicos";
    String usuario = "root";
    String contraseña = "18320996";
    public static int CodigoP = 0;
    private ArchivoProveedores archivoP;
    
    public ArchivoProveedoresMostrar(ArchivoProveedores archivoP) {
        ...
        try{
            ...
            ResultSet rs = smnt.executeQuery("SELECT Nro_Proveedor, Nombre FROM proveedores;");
            while(rs.next()){
                String numero = rs.getString("Nro_Proveedor");
        ...
        TablaMC.addMouseListener(new MouseAdapter(){
            public void mousePressed(MouseEvent Mouse_evt){
                ...
                if(Mouse_evt.getClickCount() == 1){
                    ...
                    CodigoP = Integer.parseInt(DatoSeleccionado.getText());
                    archivoP.Buscar_EstadoCuenta();
                    Salir();
                }
            }
        });
                ...
                .addGroup(PanelMuestraCodigosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(PanelMuestraCodigosLayout.createSequentialGroup()
                        .addGroup(PanelMuestraCodigosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(PanelMuestraCodigosLayout.createSequentialGroup()
                                .addGap(121, 121, 121)
                                .addComponent(DatoSeleccionado, javax.swing.GroupLayout.PREFERRED_SIZE, 271, javax.swing.GroupLayout.PREFERRED_SIZE)))
